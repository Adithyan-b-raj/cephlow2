...
- **CRITICAL**: Never run `git push` or push code to the remote repository (`origin`) without explicit prior permission from the user in the chat. All code changes should remain local until push permission is granted.
