      ...
      <Sidebar>
        ...
        <SidebarHeader className="p-4 border-b-2 border-border">
          <div className="flex flex-row items-center gap-3">
            <div className="bg-foreground text-background p-1.5 flex items-center justify-center border border-border">
              <img src="/favicon-32x32.png" alt="Cephlow" className="w-5 h-5 shrink-0" />
            </div>
