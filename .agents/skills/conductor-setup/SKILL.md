...
2.  **Select Code Style Guides:**
    ...
    -   **FOR BROWNFIELD PROJECTS:**
        ...
        -   **If user chose "Add More":**
            -   **Action:** Announce "I'll present the additional guides. Please select all that apply." Then, immediately call the `ask_user` tool (do not repeat the list in the chat).
